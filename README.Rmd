...
`session_mcd_provisional` - [Provisional Mortality Statistics, 2018 through
...
application](https://wonder.cdc.gov) already lets you retrieve sub-national
and it's probably no big deal to use this package
