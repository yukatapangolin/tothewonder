...
WONDER](https://wonder.cdc.gov) firearm homicide data.  This package
...
_Note that it's possible this package violates the terms of use of the
...
allows you retrieve county-level data_
