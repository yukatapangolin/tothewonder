...
test_that("Test that ICD code MCD final18 queries are saved correctly", {
  ...
  expect_true(grepl(paste0(
    '<textarea wrap="off" id="TD157.V13-AND2"',
    ' name="V_D157.V13_AND">S00-T98</textarea>'),
    mcd_saved_txt))
