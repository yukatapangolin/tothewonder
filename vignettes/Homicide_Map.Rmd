...
tmpdir <- tempdir()
untar("https://github.com/yukatapangolin/files-tothewonder/blob/master/ERS-2010-2fcqzlr.tar.xz?raw=true", exdir = tmpdir )
#> Warning in untar("https://github.com/yukatapangolin/files-tothewonder/blob/
#> master/ERS-2010-2fcqzlr.tar.xz?raw=true", : '/bin/tar -xf 'https://github.com/
#> yukatapangolin/files-tothewonder/blob/master/ERS-2010-2fcqzlr.tar.xz?raw=true'
#> -C '/tmp/RtmpmH7ZsG'' returned error code 128
ers <- st_read(paste0(tmpdir, "/ERS-2010-2fcqzlr/", "ERS10.shp"))
#> Error: Cannot open "/tmp/RtmpmH7ZsG/ERS-2010-2fcqzlr/ERS10.shp"; The file doesn't seem to exist.
ers <- sf::st_transform(ers, "+init=epsg:2163")
#> Error in sf::st_transform(ers, "+init=epsg:2163"): object 'ers' not found
...
ers_lm <- merge(ers,
                ...
                by.y = "LM_Code",
                all = TRUE)
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'merge': object 'ers' not found
```
...
#> Error in fortify(data): object 'ers_lm' not found
```
...
#> Error in eval(expr, envir, enclos): object 'ers' not found
name = 2e6
for(ll in new_cz) {
  for (v in ll) {
...
ers2 <- ers |>
  ...
  ungroup()
#> Error in group_by(ers, LM_Code2): object 'ers' not found
...
ers_lm2 <- merge(ers2,
                 ...
                 by.y = "LM_Code2",
                 all = TRUE)
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'merge': object 'ers2' not found
```
...
ggplot() +
  ...
  theme(plot.background = element_rect(fill = "white", color = "white"),
        text=element_text(size=16,  family="SF Pro Display"))
#> Error in fortify(data): object 'ers_lm2' not found
```
